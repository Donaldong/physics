...
giant = sphere(pos=vector(-1e11,0,0), radius=2e10, color=color.green, 
                make_trail=False, trail_type='points', interval=10, retain=50)
giant.mass = 2e30
giant.p = vector(0, 0, -1e4) * giant.mass

dwarf = sphere(pos=vector(1.5e11,0,0), radius=1e10, color=color.blue,
                make_trail=False, interval=10, retain=50)
dwarf.mass = 2e30
dwarf.p = -giant.p
